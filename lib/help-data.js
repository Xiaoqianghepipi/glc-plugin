import { pluginName, resourceRoot, resourceRootUrl } from './config.js'

export function buildHelpData() {
  return {
    tplFile: `${resourceRoot}/help/index.html`,
    defaultLayout: `${resourceRoot}/common/layout/default.html`,
