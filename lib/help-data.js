    ...
    helpGroup: [
      ...
      },
      {
        ...
        list: [
          ...
          attachAvatar({ title: '&开启卡池定时拉取', desc: '开启定时拉取卡池数据' }),
          attachAvatar({ title: '&关闭卡池定时拉取', desc: '关闭定时拉取卡池数据' }),
          attachAvatar({ title: '&设置卡池拉取cron 30 12 * * *', desc: '设置卡池拉取 Cron 时间' }),
          attachAvatar({ title: '&查看卡池拉取结果', desc: '查看卡池定时拉取结果' }),
